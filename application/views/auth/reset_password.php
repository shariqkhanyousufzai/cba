        ...
        <div class="login-content flex-row-fluid d-flex flex-column justify-content-center position-relative overflow-hidden p-7 mx-auto">
          ...
          <div class="d-flex flex-column-fluid flex-center">
            ...
            <div class="login-form login-signin">
              <!--begin::Form-->
              <form class="form" method="post" action="<?= base_url('auth/reset_password/').$code?>" novalidate="novalidate">
                <!--begin::Title-->
                ...
                <div class="form-group" style="position: relative;">
                  <label class="font-size-h6 font-weight-bolder text-dark">New Password (Minimum Length Of Password - <?=$min_password_length?>)</label>
                  <input class="form-control form-control-solid h-auto p-6 rounded-lg new" type="password" name="new" autocomplete="off" />
                 
                </div>
                <div class="form-group" style="position: relative;">
                  <label class="font-size-h6 font-weight-bolder text-dark">New Confirm Password</label>
                  <input class="form-control form-control-solid h-auto p-6 rounded-lg new_confirm" type="password" name="new_confirm" autocomplete="off" />
                ...
                <div class="pb-lg-0 pb-5" align="right">
                  <button type="submit"  class="themebtn btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3">Change Password</button>
                </div>
                <!--end::Action-->
              </form>
              <!--end::Form-->
