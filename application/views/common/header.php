...
<li class="menu-item  <?= ($this->uri->segment(1) == 'investor' && ($this->uri->segment(2) == 'investor_profile' || $this->uri->segment(2) == 'pay_investment' )) ? 'menu-item-active' : ''; ?>" aria-haspopup="true">
<a href="<?php echo base_url('investor/investor_profile/').$this->session->userdata('user_id') ?>" class="menu-link">
<span class="svg-icon menu-icon">
<!--begin::Svg Icon | path:<?=$assets?>/media/svg/icons/Design/Layers.svg-->
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
	<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
...
<span class="menu-text">My Investment Profile</span>
</a>
</li>
