    ...
    <div class="subheader py-2 py-lg-6 subheader-transparent" id="kt_subheader">
        <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Title-->
                <h5 class="text-dark font-weight-bolder mt-2 mb-2 mr-5">View User</h5>
                <!--end::Title-->
                <!--begin::Separator-->
                        ...
                        <ul class="nav nav-tabs nav-bold nav-tabs-line nav-tabs-line-3x">
                            ...
                            <li class="nav-item mr-3">
                                <a class="nav-link" data-toggle="tab" href="#kt_user_edit_tab_3">
                                    ...
                                    <span class="nav-text font-size-lg">All Investment</span>
                                </a>
                            </li>
                            ...
                            <li class="nav-item mr-3">
                                <a class="nav-link" data-toggle="tab" href="#kt_user_edit_tab_4">
                                    ...
                                    <span class="nav-text font-size-lg">Graphical Representation</span>
                                </a>
                            </li>
                            <!--end::Item-->
                        </ul>
                        ...
                        <div class="tab-pane show active px-7" id="kt_user_edit_tab_1" role="tabpanel">
                            ...
                            <div class="row">
                                <div class="col-sm-6 form-group fv-plugins-icon-container">
                                    ...
                                    <input type="text" class="form-control" readonly="" disabled="" name="full_name" value="<?=$getAllUserData['data'][0]->full_name?>">
                                </div>
                                <div class="col-sm-6 form-group fv-plugins-icon-container">
                                    <label><i class="fab fa-yelp" style="line-height: 39px;color: #50aec3;margin-right:5px"></i>Email:</label>
                                    <input type="text" class="form-control" readonly="" disabled="" name="full_name" value="<?=$getAllUserData['data'][0]->email?>">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12 form-group fv-plugins-icon-container">
                                    ...
                                    <input type="text" class="form-control" readonly="" disabled="" name="full_name" value="<?=$getAllUserData['data'][0]->address?>">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-4 form-group fv-plugins-icon-container">
                                    ...
                                    <input type="text" class="form-control" readonly="" disabled="" name="full_name" value="<?=$getAllUserData['data'][0]->country?>">
                                </div>
                                <div class="col-sm-4 form-group fv-plugins-icon-container">
                                    <label><i class="fab fa-yelp" style="line-height: 39px;color: #50aec3;margin-right:5px"></i>City:</label>
                                    <input type="text" class="form-control" readonly="" disabled="" name="full_name" value="<?=$getAllUserData['data'][0]->city?>">
                                </div>
                                <div class="col-sm-4 form-group fv-plugins-icon-container">
                                    <label><i class="fab fa-yelp" style="line-height: 39px;color: #50aec3;margin-right:5px"></i>Zip:</label>
                                    <input type="text" class="form-control" readonly="" disabled="" name="full_name" value="<?=$getAllUserData['data'][0]->zip_code?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-12" align="left">
                                    <div class="image-input image-input-empty image-input-outline" id="kt_user_edit_avatar" style="background-image: url(<?php echo base_url('assets/uploads/' . $getAllUserData['data'][0]->avatar); ?>)">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button data-target="#contractmodal_<?=$i?>" data-toggle="modal" class="btn mt-2 btn-md w-lg-100 btn-dark btn-icon send_msg" title="Contract">
                                        <span class="svg-icon svg-icon-md">
